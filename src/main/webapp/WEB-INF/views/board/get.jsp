	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label>댓글 작성자</label>
					<input class="form-control" name="replier" value="댓글러">
				</div>
...
$(document).ready(function()
{
	...
	function showReplyPage(replyCnt)
	{
		...
		if(prev)
		{
			str += "<li class='page-item'><a class='page-link' href='" + (beginNum - 1) + "'>이전</a></li>";
		}
...
$(document).ready(function()
{
	...
	$("button[data-oper='remove']").on("click", function(e)
	{
		...
		if(operation === 'remove')
		{
			let isDelete = alert("글을 삭제하시겠습니까?");
